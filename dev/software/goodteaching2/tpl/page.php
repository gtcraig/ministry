...
if (!empty($preview_author)) {
  ...
  echo "<p class='left'><b>$preview_author</b> <span class='grey-text'>Volume</span> <b>$preview_vol</b> <span class='grey-text'>Page</span> <b>$preview_page</b></p>  <p class='right'><a class='btn-flat waves-effect' href='{$root}read/index.php?preview_go=go'>Read</a></p>";

?><table class="striped highlight compact-table"><tbody><?php
...
?></tbody></table><div align="center" style="padding-top:10px;">
