...
?>
<p><a href="javascript:void" onclick="submitBookRef('NULL');return false;">Books</a>
	&nbsp;|&nbsp;<?php echo $bibleBook->getBookName(); ?>
</p>
<p>Chapters
<?php
...
?>
	<a href="javascript:void();" onclick="submitBookRef(<?php echo $bibleBook->getBookId(); ?>, <?php echo $chapter; ?>);return false;"><?php echo $chapter; ?></a> &emsp; 
<?php
  }
?>
	</p>
...
?>
	<a href="javascript:void();" onclick="submitBookRef(<?php echo $bibleBook->getBookId(); ?>, <?php echo $chapter; ?>, <?php echo $vstart; ?>); return false;"><?php echo ($vstart==0) ? "All": $vstart; ?></a>
	&emsp;
<?php
  }
?>
