...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:14px; flex-wrap:wrap; gap:10px;">
  ...
  <div>
    <form method="post" name="books" id="books">
      ...
      <label style="font-size:9pt; color:var(--text-mid); display:flex; align-items:center; gap:6px; cursor:pointer;">
        <input type="checkbox"
               onclick="getObjRef('primary').value=(this.checked)?1:0;"
               <?php echo ($primary) ? "checked" : ""; ?>>
        Search only Scriptures referenced at the beginning of an article?
      </label>
    </form>
  </div>
</div>
